...
import 'package:firebase_crud_app/view_model/item_list_view_model.dart';
...
class ItemListPage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      // itemList = AsyncValue
      // AsyncValueのwhenメソッドを使用することで、Viewの反映、ローディング時、エラー時の3つの処理を書くことができます
      body: itemList.when(
      ...
      floatingActionButton: FloatingActionButton(
        // タスク作成ダイアログを表示する（Item.emptyで値を追加するときに入力時のデータを毎回空にする）
